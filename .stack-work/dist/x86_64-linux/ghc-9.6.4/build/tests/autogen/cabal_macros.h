...
/* package copa-backend-0.1.0.0 */
#ifndef VERSION_copa_backend
#define VERSION_copa_backend "0.1.0.0"
#endif /* VERSION_copa_backend */
#ifndef MIN_VERSION_copa_backend
#define MIN_VERSION_copa_backend(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_copa_backend */
...
#define CURRENT_COMPONENT_ID "copa-backend-0.1.0.0-48NVSTJAzUQDLeb7sRRFeM-tests"
